 ...
 */
public class MockLightingManager {

    public static boolean mockSwitchOnLamp(String identifierzone,String identifier) throws InterruptedException, IOException, I2CFactory.UnsupportedBusNumberException {
    ...
    public static boolean mockSwitchOffLamp(String identifierzone,String identifier) throws InterruptedException, IOException, I2CFactory.UnsupportedBusNumberException
    {
        Zone zone = lightingConfigurationInstance.getZones().stream().filter(o -> o.getId().equals(identifierzone)).findFirst().get();
        Lamp lamp = zone.getLamps().stream().filter(o -> o.getIdentifier().equals(identifier)).findFirst().get();
        if(Environment.isDevEnv())
    ...
    public static boolean mockGetStatusAllLamps() throws InterruptedException {
        if(!Environment.isDevEnv())
        {
    ...
    public static boolean mockSwitchOffLampAll() throws InterruptedException, IOException, I2CFactory.UnsupportedBusNumberException
    {
        if(Environment.isDevEnv())
        {
    ...
    public static boolean mockSwitchOnLampAll() throws InterruptedException, IOException, I2CFactory.UnsupportedBusNumberException
    {
        if(Environment.isDevEnv())
        {
            System.out.println("all lamp : Off");
